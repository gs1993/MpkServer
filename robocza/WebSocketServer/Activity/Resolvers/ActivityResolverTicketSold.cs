...
{
    public class ActivityResolverTicketSold:IActivityResolver
    {
        private readonly IDatabaseService _databaseService;

        private readonly IEventEmitter _eventEmitter;

        public ActivityResolverTicketSold(IDatabaseService databaseService, IEventEmitter eventEmitter)
        {
            _databaseService = databaseService;
            _eventEmitter = eventEmitter;
        }

        public ActivityType ActivityType => ActivityType.TicketSell;
